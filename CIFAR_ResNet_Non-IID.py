...
if __name__ == "__main__":
    ...
    # with open(os.path.join(save_dir_path, 'col_performance_non-iid_fedGD_'+str(N_rounds)+'_'+str(N_alignment)+'_'+str(N_samples_per_class*6)+'.pkl'), 'wb') as f:
    #     pickle.dump(collaboration_performance, f, protocol=pickle.HIGHEST_PROTOCOL)
    with open(os.path.join(save_dir_path, 'col_performance_non-iid_fedGD_' + str(N_logits_matching_round) + '_'
